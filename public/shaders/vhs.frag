...
vec3 rgb2yiq(vec3 c) {
	return vec3((0.299 * c.r + 0.5959 * c.g + 0.2115 * c.b), (0.587 * c.r - 0.2746 * c.g - 0.5227 * c.b), (0.114 * c.r - 0.3213 * c.g + 0.3112 * c.b));
}

vec3 yiq2rgb(vec3 c) {
	return vec3((1.0 * c.r + 1.0 * c.g + 1.0 * c.b), (0.956 * c.r - 0.272 * c.g - 1.106 * c.b), (0.619 * c.r - 0.647 * c.g + 1.703 * c.b));
}
